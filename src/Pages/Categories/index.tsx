...
const Categories = () => {
  return (
    <>
        ...
        <ProductList games={breve} title='Ação' background='black' />
        <ProductList games={promocoes} title='Aventura' background='gray' />
        <ProductList games={breve} title='FPS' background='black' />
        <ProductList games={promocoes} title='Esporte' background='gray' />
      </>
  )
}
